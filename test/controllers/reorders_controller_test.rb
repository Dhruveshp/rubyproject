...
class ReordersControllerTest < ActionController::TestCase
  ...
  test "should create reorder" do
    assert_difference('Reorder.count') do
      post :create, reorder: { expecteddelivery: @reorder.expecteddelivery, product_id: @reorder.product_id, qtyorder: @reorder.qtyorder, reorderdate: @reorder.reorderdate, supplier_id: @reorder.supplier_id }
    end
  ...
  test "should update reorder" do
    patch :update, id: @reorder, reorder: { expecteddelivery: @reorder.expecteddelivery, product_id: @reorder.product_id, qtyorder: @reorder.qtyorder, reorderdate: @reorder.reorderdate, supplier_id: @reorder.supplier_id }
    assert_redirected_to reorder_path(assigns(:reorder))
  end
